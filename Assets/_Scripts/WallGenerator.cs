...
public static class WallGenerator
{
    public static void CreateWalls(HashSet<Vector2Int> floorPositions, TilemapVisualizer tilemapVisualizer)
    {
        ...
        CreateCornersWalls(tilemapVisualizer, cornerWallPositions, floorPositions);
    }

    public static HashSet<Vector2Int> GetWallsPositions(HashSet<Vector2Int> floorPositions)
    {
        HashSet<Vector2Int> wallsPositions = floorPositions;

        var basicWallPositions = FindWallsInDirections(floorPositions, Direction2D.cardinalDirectionsList);
        var cornerWallPositions = FindWallsInDirections(floorPositions, Direction2D.diagonalDirectionsList);

        wallsPositions.ExceptWith(basicWallPositions);
        wallsPositions.ExceptWith(cornerWallPositions);
    ...
    private static void CreateCornersWalls(TilemapVisualizer tilemapVisualizer, HashSet<Vector2Int> cornerWallPositions, HashSet<Vector2Int> floorPositions)
    {
